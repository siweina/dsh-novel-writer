...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = "[data-pane=conversation],[class*=centerCol]{position:relative}" +
      ...
      ".nwToolGroupHead{display:flex;align-items:center;gap:8px;width:100%;padding:9px 12px;background:rgba(127,127,127,.08);border:none;cursor:pointer;font-size:13px;text-align:left;color:inherit}" + 
