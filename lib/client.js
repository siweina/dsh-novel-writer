...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zh = {
      ...
      "panel.featuresHint": "情感净化预警：剔除生理/爽感词干扰后提示 AI 复核真实情绪；题材与流派检测：detect 时输出主/副题材与设定流派。",
      "feature.emotionCaveat": "情感净化预警",
      "feature.emotionCaveat.desc": "剔除 R18/爽文/恐怖生理反应词，污染时提示 AI 抽查原文复核。",
    ...
    var en = {
      ...
      "feature.emotionCaveat": "Emotion caveat",
      "feature.emotionCaveat.desc": "Strip R18/action/horror reaction words; warn and ask AI to sample-check when polluted.",
    ...
    var ALL_TOOLS = ["novel_books", "novel_chapters", "novel_read", "novel_keywords", "novel_new_chapter", "novel_import", "novel_sentence_analysis", "novel_sentence_config", "novel_style_check", "novel_plot", "novel_settings", "novel_summary", "novel_continuity_check"];
      ...
      return {
        ...
        refresh: function () {
          return fetchState().then(function (remote) {
            controller.set({
              ...
              hostOk: true,
              loading: false,
              revealMsg: t("panel.refreshed"),
              revealErr: false
            });
            return remote;
          }).catch(function () {
            controller.set({ hostOk: false, loading: false, revealMsg: t("plot.revealErr") + "：宿主端不可达", revealErr: true });
            return null;
          });
        },
        openDataDir: function () {
          ...
          fetch("/api/dsh-novel-writer/reveal", {
            ...
            body: JSON.stringify({ target: "data-dir" })
          }).then(function (r) { return r.json(); }).then(function (data) {
            if (data.ok === true) {
              controller.set({ dataDir: data.path || controller.getSnapshot().dataDir, revealMsg: t("plot.revealOk") + "：" + (data.path || ""), revealErr: false });
            } else {
        ...
        copyPlotsPath: function () {
          var dir = controller.getSnapshot().dataDir || controller.getSnapshot().plotsDir;
          if (dir === "") {
            controller.set({ revealMsg: t("plot.pathUnknown"), revealErr: true });
            return;
          }
          var done = function () {
    ...
    function PanelView(props) {
      ...
      return react.createElement(
        ...
        react.createElement(
          ...
          react.createElement(
            "button",
            { type: "button", className: "nwRefresh", onClick: function () { props.controller.refresh(); } },
            t("panel.refresh")
          ),
        ...
        react.createElement("div", { className: "nwSectionTitle" }, t("panel.featuresTitle")),
        react.createElement("div", { className: "nwToolsHint" }, t("panel.featuresHint")),
        ["emotionCaveat", "genreTheme", "emotionComplexity"].map(function (name) {
          var fOn = (state.features || {})[name] !== false;
          return react.createElement(
            "div",
            { className: "nwToolRow" + (fOn ? " nwToolRowOn" : ""), key: name },
            react.createElement(
              "div",
              { className: "nwToolLabel" },
              react.createElement("div", null, t("feature." + name)),
              react.createElement("div", { className: "nwToolDesc" }, t("feature." + name + ".desc"))
            ),
            react.createElement(
              "button",
              {
                type: "button",
                role: "switch",
                "aria-checked": fOn ? "true" : "false",
                className: "nwSwitchSmall" + (fOn ? " nwSwitchSmallOn" : ""),
                disabled: state.loading,
                onClick: function () { props.toggle({ features: (function (patch) { patch[name] = !fOn; return patch; })({}) }); }
              },
        ...
        ALL_TOOLS.map(function (name) {
          ...
          var plotExtra = null;
          if (name === "novel_plot") {
            var dir = state.dataDir || state.plotsDir;
            var pathText = dir !== "" ? dir : t("plot.pathUnknown");
            plotExtra = react.createElement(
              "div",
              { className: "nwPlotBox" },
              react.createElement("div", { className: "nwPlotPath", title: dir !== "" ? dir : "" }, t("plot.pathLabel") + "：" + pathText),
              react.createElement(
                "div",
                { className: "nwBtnGroup" },
                react.createElement("button", {
                  type: "button", className: "nwBtn", disabled: state.revealing,
                  onClick: function () { props.controller.openDataDir(); }
                }, t("plot.open")),
                react.createElement("button", {
                  type: "button", className: "nwBtn",
